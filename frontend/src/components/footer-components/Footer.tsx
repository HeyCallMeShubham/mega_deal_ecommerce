                    ...
                    <div className="lg:flex lg:items-start lg:gap-8">
                        ...
                        <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                            <div className="col-span-2">
                                <div>
                                    <h2 className="text-2xl font-bold text-white">Shop The Best</h2>
                            ...
                            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                                <form className="w-full">
                                    ...
                                    >
                                        ...
                                        <button
                                            className="mt-1 w-full bg-primaryBg px-6 py-3 text-sm font-bold tracking-wide text-white uppercase transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
                                        >
                                            Sign Up
                                        </button>
                                    </div>
