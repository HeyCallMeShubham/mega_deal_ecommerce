...
const ReviewSection = () => {
    return (
        <>
            <section className="bg-white max-w-6xl mx-auto  xsm:px-6 lg:px-8 py-8 antialiased md:py-16 w-full ">
                <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="mt-2 flex items-center gap-2 sm:mt-0">
                            ...
                            <a
                                href="#"
                                className="text-sm font-medium leading-none text-black underline hover:no-underline "
                            >
                                {" "}
                                645 Reviews{" "}
                            </a>
                    ...
                    <div className="my-6 gap-8 sm:flex sm:items-start md:my-8">
                        <div className="shrink-0 space-y-4">
                            ...
                            <button
                                ...
                                className="mb-2 me-2 bg-secondaryBg rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                            >
                                Write a review
                            </button>
                        </div>
                        <div className="mt-6 min-w-0 flex-1 space-y-3 sm:mt-0">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <a
                                    href="#"
                                    className="w-8 shrink-0 text-right text-sm font-medium leading-none text-black hover:underline dark:text-primary-500 sm:w-auto sm:text-left"
                                >
