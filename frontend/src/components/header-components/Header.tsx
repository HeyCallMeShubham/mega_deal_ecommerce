      ...
      <header className="lg:h-[5rem] w-screen border border-black xsm:min-w-[24rem] xsm:max-w-auto xsm:px-4 md:px-10 lg:px-32  ">
        <nav className="flex flex-row justify-between h-full items-center py-2">
          ...
          <div className="hidden h-full lg:flex   items-center gap-8">
            ...
            <span className="text-[1.3rem] relative after:content-['01'] after:text-[13px] after:text-white after:rounded-full after:p-[4px]  after:text-center after:items-center after:content-center after:absolute after:bottom-[10%] after:left-full h-2 w-2 after:bg-primaryBg cursor-pointer">
              <IoIosHeartEmpty />
            </span>
