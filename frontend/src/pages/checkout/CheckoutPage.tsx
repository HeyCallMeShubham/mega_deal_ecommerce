...
const CheckoutPage = () => {
    ...
    return (
        ...
        <div className='w-screen xsm xsm:min-h-screen xsm:max-h-auto lg:min-h-screen lg:max-h-auto md:min-h-screen md:max-h-auto lg:items-start flex justify-center px-1 py-1 '>

            <div className='flex flex-col xsm:w-full xsm:min-h-full xsm:max-h-auto xsm:flex xsm:flex-col md:w-full xsm:items-center lg:items-start md:items-center lg:w-[70rem] lg:min-h-full lg:max-h-auto   border border-yellow-700'> {/*parent-1*/}

                <h2 className=' w-full text-[1rem] items-center text-center h-11 bg-primaryBg text-white border font-bold self-center border-black'>Getting Your Order</h2>

                <div className='flex xsm:flex-col lg:flex-row lg:w-full'>

                    <div className="flex flex-col lg:w-full border border-red-400">

                        <form className='flex xsm:flex-col lg:flex-col md:flex-col md:justify-center xsm:gap-5 md:gap-8 xsm:w-full lg:w-[40rem] xsm:h-full md:h-full md:items-center lg:justify-start lg:md:w-[60rem] px-2 py-2 border border-black  '>

                            <div className='flex xsm:flex-col md:flex-row lg:flex-col xsm:items-center lg:items-start md:items-center md:justify-center  gap-2 md:w-full '>

                                <label htmlFor='First-Name' className="flex flex-col xsm:items-center xsm:w-[14rem] lg:w-[18rem] lg:h-[3.5rem] md:h-[4rem] md:w-[24rem]  ">

                                    First Name

                                    <input type="text" placeholder="First Name" className="h-full w-full  text-center p-2 text-[1rem] border border-black" />

                                </label>



                                <label htmlFor='Last-Name' className="flex flex-col xsm:items-center xsm:w-[14rem]  lg:w-[18rem] lg:h-[3.5rem] md:h-[4rem] md:w-[24rem] ">

                                    Last Name

                                    <input type="text" placeholder="Last Name" className="h-full w-full text-center p-2 text-[1rem] border border-black" />
                            ...
                            <div className='flex xsm:flex-col md:flex-row lg:flex-row xsm:items-center  lg:items-start md:items-center  lg:justify-start md:justify-center   gap-2 md:w-full'>

                                <label htmlFor='Phone' className="flex flex-col xsm:items-center xsm:w-[14rem]  lg:w-[18rem] lg:h-[3.5rem]   md:h-[4rem] md:w-[24rem]  ">

                                    Phone

                                    <input type="tel" placeholder="Phone Number" className="h-full w-full  text-center p-2 text-[1rem] border border-black" />

                                </label>

                                <label htmlFor='email' className="flex flex-col xsm:items-center xsm:w-[14rem]  lg:w-[18rem] lg:h-[3.5rem]  md:h-[4rem] md:w-[24rem] ">

                                    email Address

                                    <input type="email" placeholder="email" className="h-full w-full text-center p-2 text-[1rem] border border-black" />
                            ...
                            <div className='flex xsm:flex-col md:flex-row lg:flex-col xsm:items-center  lg:items-start md:items-center md:justify-center  gap-2 md:w-full'>
                                ...
                                <label htmlFor='First-Name' className="flex flex-col xsm:items-center xsm:w-[14rem] lg:w-[18rem] lg:h-[3.5rem] md:h-[4rem] md:w-[24rem]  ">
                                    ...
                                    <input type="text" placeholder="Apt #. Suite Floor" className="h-full w-full text-center p-2 text-[1rem] border border-black" />

                                </label>

                                <label htmlFor='City' className="flex flex-col xsm:items-center xsm:w-[14rem]  lg:w-[18rem] lg:h-[3.5rem] md:h-[4rem] md:w-[24rem]   ">

                                    City

                                    <input type="text" placeholder="City" className="h-full  w-full text-center p-2 text-[1rem] border border-black" />
                            ...
                            <div className='flex xsm:flex-col lg:flex lg:flex-row  xsm:items-center lg:items-start lg:justify-start gap-2 w-full'>

                                <div className=' flex flex-col lg:w-[18rem] lg:h-[3.5rem] '>
                                ...
                                <label htmlFor='zipCode' className="flex flex-col xsm:items-center xsm:w-[14rem] lg:w-[18rem] lg:h-[3.5rem] md:h-[4rem] md:w-[24rem]">

                                    ZIP Code

                                    <input type="tel" placeholder="Zip Code" className=" h-full w-full text-center p-2 text-[1rem] border border-black" />
                            ...
                            <button className='xsm:w-[8rem] xsm:h-12 lg:w-[8rem] lg:h-12 md:h-10 md:w-[8rem]  bg-secondaryBg text-white self-end text-[0.90rem] rounded-[1rem] font-bold'>submit address</button>

                        </form>


                        <div className="flex xsm:flex-col lg:flex-col md:flex-col md:justify-center xsm:gap-5 md:gap-8 xsm:w-full lg:w-[40rem] xsm:h-full md:h-full md:items-center lg:justify-start lg:md:w-[60rem] px-2 py-2 border border-black   ">

                            <h2 className=''>Choose From Your Address</h2>


                            {addresses.map((address: any) => (


                                <div className=' flex h-[8rem] w-[16rem] items-center justify-between p-4 bg-green-500 ' id='[]'>

                                    <div className=' '>

                                        <p className=''>{address.fName + " " + address.lName}</p>
                    ...
                    <div className="w-full bg-white py-8 antialiased dark:bg-secondaryBg md:py-16 lg:w-full">
                        <form action="#" className="mx-auto max-w-screen-xl px-4 2xl:px-0 w-full">
                                ...
                                <div className="mt-6 sm:mt-8">
                                    ...
                                    <div className="mt-4 space-y-6">
                                        ...
                                        <div className="gap-4 sm:flex sm:items-center">
                                            ...
                                            <button
                                                type="submit"
                                                className="mt-4 flex w-full items-center justify-center rounded-lg bg-primary-700  px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300  dark:bg-primaryBg dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:mt-0"
                                            >
                                                Place Order
                                            </button>
                                        </div>
