  ...
  return (
    <section className="min-h-screen max-h-auto bg-gray-100 py-8 antialiased md:py-12 min-w-[24rem] max-w-auto border border-black">
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div className="mb-4 grid gap-y-2 lg:gap-x-[-8] xsm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4 items-center justify-items-center content-center text-center ">
