          ...
          <div className="flex flex-wrap items-center justify-center w-full lg:min-h-[26rem] lg:max-h-[52rem] md:min-h-[25rem] md:max-h-[auto] xsm:min-h-[20rem] xsm:max-h-[auto] gap-4 lg:overflow-y-hidden  py-6 lg:px-7">
            ...
            {products.map((product) => (
              <Link to="productdetails">
                <div className="group rounded-lg relative p-5 px-4 xsm:p-1 shadow-sm lg:min-w-[16rem] lg:max-w-[16rem] md:min-w-[18rem] md:max-w-[18rem] xsm:w-[clamp(18rem,2vw,22rem)] lg:h-[clamp(24rem,2vh,26rem)] hover:cursor-pointer border border-gray-300 bg-white">
              ...
              <div>
                ...
                >
                  ...
                  <a
                    href="#"
                    aria-current="page"
                    className="relative z-10 inline-flex items-center bg-primaryBg px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    1
                  </a>
